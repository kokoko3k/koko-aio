...
<fragment filter="linear"><![CDATA[
	...
	#define in_glow_h		3.0			//(1.5)		Input signal blur/glow height tightness
	#define in_glow_power	0.67             //(1.35)	Input signal glow strength
	...
	#define DARKLINES_TRANSPARENCY	0.3		//(0.4)		0.0 to 1.0 from opaque to totally transparent
	...
	#define halo_power 1.05            //(1.1)		Halo strength
	...
	#define GAMMA					1.3		//1.5		Global Gamma correction, the higher, the darker.
