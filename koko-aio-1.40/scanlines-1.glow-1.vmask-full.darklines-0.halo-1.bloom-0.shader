...
<fragment filter="linear"><![CDATA[
	...
	#define in_glow_w		3.5				//(1.5)		Input signal blur/glow width tightness
	#define in_glow_h		3.5				//(1.5)		Input signal blur/glow height tightness
	...
	#define halo_w     2.0				//(0.5)		Halo width tightness
	#define halo_h     1.2				//(0.5)		Halo height tightness
	#define halo_power 2.2				//(2.0)		Halo strength
	...
	#define bloom_directions	13.0	//16.0		BLOOM DIRECTIONS More is better but slower)
	...
	#define bloom_mix			0.00001	//0.2		BLOOM final mix 
	...
	#define GAMMA					1.20		//1.5		Gamma correction, the higher, the darker.
