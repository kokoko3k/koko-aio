...
#define bloompixy    2.0            //1.2  Blurriness and glow height, the less the blurrier
...
#define GAMMA_COR    0.40           //0.5   Gamma correction, the higher, the darker.
...
void main()
{
	...
	pixel_processed*=vec3(0.975 , 1.00 , 1.075);
