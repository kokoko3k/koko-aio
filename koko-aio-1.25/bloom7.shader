...
/* Glow, blur */
#define glowpix     5.0            //1.2  Blurriness and glow width , the less the blurrier
...
#define BLOOM_SIGMA       2.0	  //lowering this, will make the the gaussian steeper, start with 10.0
#define BLOOM_GAMMA   1.5     //higher values limit bloom to brighter colors, range 1.0 - 10.0



/* Post effects: */

#define saturation   1.2           //1.0    Saturation modifier, 1.0 is neutral saturation.
