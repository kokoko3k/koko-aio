...
#define DARKLINE_HEIGHT         3       //2      straight darkline height
...
/* Glow, blur */
#define glowpix     1.5            //1.2  Blurriness and glow width , the less the blurrier
#define glowpixy    1.5            //1.2  Blurriness and glow height, the less the blurrier
#define glow        1.2           //1.2  Glow Strength, sane values from 1.0 to 1.3



/* Real bloom */
#define BLOOM_KERNEL_SIZE 6      //bloom steps, the more the smoother, the slower, 4 could be enough.
#define BLOOM_WIDTH       0.006    //bloom width,  0.01 is a good starting point
#define BLOOM_HEIGHT      0.006    //bloom height, 0.01 is a good starting point
#define BLOOM_MULTIPLIER  1.8    //the more, the bloomer, try in range 3.0 - 5.0
...
#define GAMMA_COR    0.3           //0.5   Gamma correction, the higher, the darker.
//                              R   G   B
