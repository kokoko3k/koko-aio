...
<fragment scale="1.0" filter="nearest"><![CDATA[
    ...
    #define SCAN_OVER_WHITE         0.4      //0.2  How much scanlines affect bright colors. Range [0.0 -> 1.0] 
...
/* Glow, blur */
#define glowpix     1.2            //1.2  Blurriness and glow width , the less the blurrier
#define glowpixy    1.2            //1.2  Blurriness and glow height, the less the blurrier
#define glow         1.4           //1.2  Glow Strength, sane values from 1.0 to 1.3
...
#define GAMMA_COR    0.30           //0.5   Gamma correction, the higher, the darker.
//                              R   G   B
