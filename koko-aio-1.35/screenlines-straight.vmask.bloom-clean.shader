...
<fragment filter="linear"><![CDATA[
	...
	#define in_glow_power	0.4             //(1.35)	Input signal glow strength
	...
	#define DARKLINES_TRANSPARENCY	0.5		//(0.4)		0.0 to 1.0 from opaque to totally transparent
	...
	#define halo_power 0.8            //(2.0)		Halo strength
	...
	#define bloom_mix			0.2		//0.2		BLOOM final mix 
