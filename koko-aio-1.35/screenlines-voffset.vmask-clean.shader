...
<fragment filter="linear"><![CDATA[
	...
	#define in_glow_w		1.3				//(1.5)		Input signal blur/glow width tightness
	#define in_glow_h		1.3				//(1.5)		Input signal blur/glow height tightness
	...
	#define halo_w     1.3            //(0.5)		Halo width tightness
	#define halo_h     1.3            //(0.5)		Halo height tightness
	...
	#define bloom_size			2.0		//5.0		BLOOM SIZE (Radius)
