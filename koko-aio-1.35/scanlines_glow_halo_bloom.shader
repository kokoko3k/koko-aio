...
<fragment scale="1.0" filter="linear"><![CDATA[
    ...
    #define s2				0.00	//(0.01)		odd scanlines opacity
...
<fragment filter="linear"><![CDATA[
	...
	#define in_glow_w		3.0				//(1.5)		Input signal blur/glow width tightness
	#define in_glow_h		5.0				//(1.5)		Input signal blur/glow height tightness
	#define in_glow_power	1.5            //(1.35)		Input signal glow strength
	#define in_glow_gamma	2.0				//(5.0)		1.0-9.0, The higher,  the less the glow on dark colors, use integers.
	...
	#define halo_power 1.2           //(2.0)		Halo strength
	#define halo_gamma 5.0            //(5.0)		1.0-9.0 The higher, the less the halo on dark colors, use integers.
	...
	#define GAMMA					1.6	//1.5		Gamma correction, the higher, the darker.
