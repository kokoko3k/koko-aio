...
<fragment filter="linear"><![CDATA[
	...
	#define IN_GLOW_ADD		0.5				//0.0		0.0-1.0 glow overflows from the scanlines and image becomes sharper
	...
	#define in_glow_power	1.2             //(1.35)	Input signal glow strength
	#define in_glow_gamma	3.0				//(5.0)		1.0-9.0, The higher,  the less the glow on dark colors, use integers.
	...
	// RGB mask:       R     G     B
    #define m1 vec3 ( 1.0 , 0.8 , 0.8 )    //col 1
    #define m2 vec3 ( 0.8 , 1.0 , 0.8 )    //col 2
    #define m3 vec3 ( 0.8 , 0.8 , 1.0  )   //col 3
	...
	#define halo_power 1.0				//(2.0)		Halo strength
	...
	#define bloom_gamma			5.0		//3.0		1.0-9.0 integer: restrict bloom to bright colors
