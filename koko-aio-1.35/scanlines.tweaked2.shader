...
<fragment filter="linear"><![CDATA[
	...
	#define DO_IN_GLOW		false			//(true)	Input signal glow
	...
	#define in_glow_h		1.5				//(1.5)		Input signal blur/glow height tightness
	#define in_glow_power	1.0             //(1.35)	Input signal glow strength
	#define in_glow_gamma	1.0				//(5.0)		1.0-9.0, The higher,  the less the glow on dark colors, use integers.

	#define FIX_SCANLINES	true			//(true)	Mitigate dephasing when FS-UAE scales the texture
	...
	#define halo_power 1.7				//(2.0)		Halo strength
	...
	#define GAMMA					1.8		//1.5		Gamma correction, the higher, the darker.
