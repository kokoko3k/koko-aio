...
<fragment scale="1.0" filter="nearest"><![CDATA[
    ...
    #define SCAN_OVER_WHITE         0.2      //0.2  How much scanlines affect bright colors. Range [0.0 -> 1.0] 
...
#define VMASK_OVER_WHITE          1.0    //0.5   How much rgb vmask affects bright colors. Range [0.0 -> 1.0] 
...
#define glow         1.8            //1.2  Glow Strength, sane values from 1.0 to 1.3
