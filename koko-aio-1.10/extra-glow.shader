...
#define DO_SCREENLINES            1       //1      1 Enable screenlines
...
#define DO_BLOOM_OVER_VMASK       1       //0      1 draw bloom 'over' VMASK pattern      
...
#define VMASK_OVER_WHITE          0.3    //0.5   How much rgb vmask affects bright colors. Range [0.0 -> 1.0] 
#define SCRNLN_OVER_WHITE         0.1   //0.05   How much screenlines or vmask frame affect bright colors. Range [0.0 -> 1.0] 
...
#define SCREENLINES_TRANS         0.3     //0.0    Screenlines or vmask frame alpha. Range [0.0 -> 1.0], ** 0.0 is the darker **



/* Bloom, glow, blur */
#define bloompix     0.6            //1.2  Blurriness and glow width , the less the blurrier
#define bloompixy    0.6            //1.2  Blurriness and glow height, the less the blurrier
...
#define saturation   0.9            //1.0    Saturation modifier, 1.0 is neutral saturation.
#define GAMMA_COR    0.75           //0.5   Gamma correction, the higher, the darker.
