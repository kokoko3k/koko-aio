...
#define DO_BLOOM_OVER_VMASK       1       //0      1 draw bloom 'over' VMASK pattern (need higher GAMMA_COR)  
...
#define DARKLN_OVER_WHITE         0.20   //0.05   How much darklines or vmask frame affect bright colors. Range [0.0 -> 1.0] 
...
#define DARKLINES_TRANS         0.75     //0.0    Darklines or vmask frame alpha. Range [0.0 -> 1.0], ** 0.0 is the darker **
...
#define saturation   1.05           //1.0    Saturation modifier, 1.0 is neutral saturation.
#define GAMMA_COR_R    0.66          //0.5   Gamma correction, the higher, the darker.
#define GAMMA_COR_G    0.65           //0.5   Gamma correction, the higher, the darker.
#define GAMMA_COR_B    0.64           //0.5   Gamma correction, the higher, the darker.
//                              R   G   B
