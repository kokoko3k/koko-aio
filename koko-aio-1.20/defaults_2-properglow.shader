...
#define DARKLN_OVER_WHITE         0.1    //0.05   How much darklines or vmask frame affect bright colors. Range [0.0 -> 1.0] 
...
#define glow         1.3           //1.2  Glow Strength, sane values from 1.0 to 1.3
