...
#define DO_BLOOM_OVER_SCRNL       1       //0      1 draw bloom 'over' darklines
...
#define VMASK_OVER_WHITE          0.25    //0.5   How much rgb vmask affects bright colors. Range [0.0 -> 1.0] 
#define DARKLN_OVER_WHITE         0.05   //0.05   How much darklines or vmask frame affect bright colors. Range [0.0 -> 1.0] 
...
/* Bloom, glow, blur */
#define bloompix     1.7           //1.2  Blurriness and glow width , the less the blurrier
#define bloompixy    1.7           //1.2  Blurriness and glow height, the less the blurrier
...
#define saturation     1.00           //1.0    Saturation modifier, 1.0 is neutral saturation.
#define GAMMA_COR_R    0.41          //0.5   Gamma correction, the higher, the darker.
#define GAMMA_COR_G    0.40           //0.5   Gamma correction, the higher, the darker.
#define GAMMA_COR_B    0.39           //0.5   Gamma correction, the higher, the darker.
//                              R   G   B
...
//                      R      G      B
//    #define m1 vec3 ( 1.0 , 0.25 , 0.25 )    //col 1
//    #define m2 vec3 ( 0.25 , 1.0 , 0.25 )    //col 2
//    #define m3 vec3 ( 0.25 , 0.25 ,  1.0 )    //col 3
