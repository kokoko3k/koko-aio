...
#define DARKLINES_TRANS         0.5     //0.0    Darklines or vmask frame alpha. Range [0.0 -> 1.0], ** 0.0 is the darker **
...
#define glow         1.7           //1.2  Glow Strength, sane values from 1.0 to 1.3
...
#define GAMMA_COR    0.7           //0.5   Gamma correction, the higher, the darker.
//                              R   G   B
