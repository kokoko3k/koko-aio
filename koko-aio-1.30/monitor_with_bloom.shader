...
vec3 pixel_darklines_offset(vec3 source,float darkline_every, float darkline_trans) {
	...
	#define DO_IN_GLOW	  1.0			 //1.0 to activate
	...
	#define DO_HALO	   1.0			  //1.0 to activate
	...
	#define DO_BLOOM	  		1.0	  //1.0 to activate
	...
	#define bloom_mix			0.3   // BLOOM final mix 

	#define DO_COLOR_CORRECTION	  1.0			 //1.0 to activate
